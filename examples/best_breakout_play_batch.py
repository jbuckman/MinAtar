...
while(not batch_terminated.all()):
    ...
    batch_reward, batch_terminated = batch_env.act(numpy.array(actions))
    vector_reward, vector_terminated = vector_env.act(numpy.array(actions))
